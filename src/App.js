...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f1a] via-[#121225] to-[#0a0a0f] text-white flex flex-col items-center">
      ...
      {/* Hero Section */}
      <div className="flex flex-col justify-center items-center text-center px-4 pt-28 md:pt-32">
        <img
          src="https://cdn.discordapp.com/avatars/934937802691469433/a9f19ce2e9986dccaa8588eec590555b.webp"
          alt="Bot Logo"
          className={`w-36 h-36 md:w-48 md:h-48 rounded-full shadow-lg transition-transform duration-300 ${hover ? "scale-110 rotate-6" : "scale-100"}`}
          onMouseEnter={() => setHover(true)}
          onMouseLeave={() => setHover(false)}
        />
        <h1 className="text-3xl md:text-6xl mt-6 font-bold bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent animate-pulse">
          Meet Fartox Bot
        </h1>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="relative group mt-6 px-6 py-3 md:px-10 md:py-4 bg-blue-600 text-white font-bold text-xl rounded-3xl shadow-2xl overflow-hidden transition-transform transform hover:scale-105 hover:shadow-blue-400/50"
        >
      ...
      <section
        id="support"
        className="mt-32 flex flex-col items-center justify-center gap-6 py-16 border-t border-gray-800 text-center px-4"
      >
        ...
        <div className="flex flex-wrap gap-4 md:gap-6 justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="relative px-6 py-3 md:px-8 md:py-3 rounded-xl font-semibold text-lg overflow-hidden
      ...
      {/* Footer */}
      <footer className="py-8 w-full text-center text-gray-500 border-t border-gray-800 mt-20 px-4">
